...
We will **intentionally keep service boundaries and internal APIs message-oriented**, so the system can switch to SQS (or another queue) with minimal refactoring later.
