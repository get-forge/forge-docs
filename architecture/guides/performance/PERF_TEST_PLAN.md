...
* **Official baseline performance envelope** and **steady-state operating point** (ECS, 50 VUs,
  ...
  (raw k6 text:
  [`phase_1/ecs-native-baseline-mix-50vu-load3m-raw.txt`](phase_1/ecs-native-baseline-mix-50vu-load3m-raw.txt);
  spreadsheet extract:
  [`phase_2/ecs-native-baseline-mix-50vu-load3m-data.csv`](phase_2/ecs-native-baseline-mix-50vu-load3m-data.csv))
* **Narrative summary** (interpretation, not Phase 2 math):
  [`phase_1/ECS_NATIVE_BASELINE_MIX_50VU_LOAD3M_SUMMARY.md`](phase_1/ECS_NATIVE_BASELINE_MIX_50VU_LOAD3M_SUMMARY.md)
