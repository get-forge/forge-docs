...
- Phase 4 @ 200 VUs envelope: [`performance/phase_4/ECS_NATIVE_BASELINE_MIX_200VU_LOAD3M_ENVELOPE.md`](performance/phase_4/ECS_NATIVE_BASELINE_MIX_200VU_LOAD3M_ENVELOPE.md)
- Phase 4 @ 100 VUs envelope: [`performance/phase_4/ECS_NATIVE_BASELINE_MIX_100VU_LOAD3M_ENVELOPE.md`](performance/phase_4/ECS_NATIVE_BASELINE_MIX_100VU_LOAD3M_ENVELOPE.md)
- Baseline (Phase 2) envelope @ 50 VUs: [`performance/phase_2/ECS_NATIVE_BASELINE_MIX_50VU_LOAD3M_ENVELOPE.md`](performance/phase_2/ECS_NATIVE_BASELINE_MIX_50VU_LOAD3M_ENVELOPE.md)
...
![ECS CPUUtil (Phase 4, 200 VUs dataset)](performance/phase_4/ecs-native-baseline-mix-200vu-cpu-run-2.png)

- RDS PostgreSQL (`t3.micro`) database metrics captured during the same Phase 4 run.

![RDS PostgreSQL metrics (Phase 4, 200 VUs dataset)](performance/phase_4/rds-postgres-baseline-mix-200vu-run-2.png)
...
- **REST client connection lifecycle**
  ...
  - Mitigation was to bound reuse by setting a REST client connection TTL (documented in the Phase 4, 100 VUs envelope):
    [`performance/phase_4/ECS_NATIVE_BASELINE_MIX_100VU_LOAD3M_ENVELOPE.md`](performance/phase_4/ECS_NATIVE_BASELINE_MIX_100VU_LOAD3M_ENVELOPE.md)
...
- Test plan: [`performance/PERF_TEST_PLAN.md`](performance/PERF_TEST_PLAN.md)

Phase write-ups (recommended reading order):

- Phase 1 local baseline (internal reference): [`performance/phase_1/LOCAL_JVM_BASELINE_MIX_50VU_LOAD3M_SUMMARY.md`](performance/phase_1/LOCAL_JVM_BASELINE_MIX_50VU_LOAD3M_SUMMARY.md)
- Phase 1 ECS baseline narrative: [`performance/phase_1/ECS_NATIVE_BASELINE_MIX_50VU_LOAD3M_SUMMARY.md`](performance/phase_1/ECS_NATIVE_BASELINE_MIX_50VU_LOAD3M_SUMMARY.md)
- Phase 2 baseline envelope (math + operating point): [`performance/phase_2/ECS_NATIVE_BASELINE_MIX_50VU_LOAD3M_ENVELOPE.md`](performance/phase_2/ECS_NATIVE_BASELINE_MIX_50VU_LOAD3M_ENVELOPE.md)
- Phase 4 scaling envelopes:
  - 100 VUs: [`performance/phase_4/ECS_NATIVE_BASELINE_MIX_100VU_LOAD3M_ENVELOPE.md`](performance/phase_4/ECS_NATIVE_BASELINE_MIX_100VU_LOAD3M_ENVELOPE.md)
  - 200 VUs: [`performance/phase_4/ECS_NATIVE_BASELINE_MIX_200VU_LOAD3M_ENVELOPE.md`](performance/phase_4/ECS_NATIVE_BASELINE_MIX_200VU_LOAD3M_ENVELOPE.md)
