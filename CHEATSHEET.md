...
task seed:aws:cognito                              # seed AWS Cognito test users
task seed:local:postgres                           # sync test users to local Docker Postgres
task seed:local:cleanup                            # remove test users from AWS Cognito and local Postgres/S3
