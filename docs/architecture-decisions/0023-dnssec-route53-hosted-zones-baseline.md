...
**Status:** Accepted **Date:** 2026-04-06 **Context:** DNSSEC signing trade-offs for Route 53 child zones under signed parents; baseline posture vs portability and ACM validation.
