...
- `GPG_PRIVATE_KEY` - GPG private key for signing artifacts during releases; see [03-release-bump.yml](https://github.com/get-forge/forge-platform/blob/main/.github/workflows/03-release-bump.yml)
