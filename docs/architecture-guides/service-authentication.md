...
summary: "User login, Cognito form auth, and LinkedIn: USERAUTHENTICATION.md."
---

User login, Cognito form auth, and LinkedIn: [USER_AUTHENTICATION.md](/docs/user-authentication).
