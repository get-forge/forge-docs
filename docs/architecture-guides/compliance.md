---
title: "Security and Compliance Control Mapping for Forked Deployments"
...
| **Audit and governance plane**       | Immutable event capture, compliance logging, traceability of actions across actors and services           | `libs/audit`, `services/audit-service`, `docs/architecture-guides/audit-service.md`                                                                      |
...
| Progress | Item                                                                                   | Notes                                                                                                    | Framework hints                                                                                                      |
|:--------:|----------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------|
|    ✅     | Annotation-driven audit events to `audit-service`                                      | `libs/audit`, Postgres `audit.audit_events`, `docs/architecture-guides/audit-service.md`                 | Supports monitoring and audit objectives commonly associated with SOC 2 CC7.x and HIPAA audit controls when in scope |
