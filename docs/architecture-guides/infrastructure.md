...
summary: "Forge provisions AWS infrastructure using the AWS Cloud Development Kit (CDK) in TypeScript."
---
...
See [RUNBOOK.md](/docs/runbook) for runtime switching guidance.
...
- [CHEATSHEET.md](/docs/cheatsheet) - CDK workflows, deploy/destroy operations, LocalStack usage
- [RUNBOOK.md](/docs/runbook) - operational runbook (runtime image switching, self-hosted GHA runners)

**Tip:** Native image builds can consume significant GitHub Actions minutes. See the self-hosted GHA runner guidance in [RUNBOOK.md](/docs/runbook).
